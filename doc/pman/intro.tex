...
\texttt{SDL\_gfx}, and \texttt{SDL\_ttf}) to use. 
...
primarily by Shane T.~Mueller, Ph.D. (\href{mailto:smueller@obereed.net}{smueller@obereed.net}). This
...
For OSX, we provide a \texttt{.pkg} installer that installs all the
