...
\verb+RotatePoints+ &\verb+<[xs,yy]>+,\verb+<angle>+&Rotates point <angle> degrees\\
\addlinespace[0.2cm] 
\midrule 
...
\verb+Plus+           &\verb+<x> <y>+ \verb+<size> <w>+ \verb+<color>+ &Creates a block E as a useable polygon which can be added to a window directly.\\ 
