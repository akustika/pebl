...
\verb+Circle+ &\verb+<x>+ \verb+<y>+ \verb+<r>+  +<color>+ +<filled>+&Creates circle with 
radius r centered at position x,y\\ 
\verb+Ellipse+ &\verb+<x>+ \verb+<y>+ \verb+<rx>+ \verb+<ry>+
+<color>+ +<filled>+&Creates 
ellipse with radii rx and ry centered at position x,y\\ 
\verb+Square+ &\verb+<x>+ \verb+<y>+ \verb+<size>+ +<color>+ +<filled>+&Creates square with 
...
\verb+Line+ &\verb+<x>+ \verb+<y>+ \verb+<dx>+ \verb+<dy>+  +<color>+ +<filled>+&Creates 
