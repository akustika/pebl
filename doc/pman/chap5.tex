...
RandomDiscrete &\verb+<num>+ &Returns a random integer between 1 and \verb+<num>+ \\ 
...
\verb+Format+ &\verb+<value>+ & UNIMPLEMENTED \\ 
...
\verb+Circle+ &\verb+<x>+ \verb+<y>+ \verb+<r>+ &Creates circle with 
radius r centered at position x,y\\ 
\verb+Ellipse+ &\verb+<x>+ \verb+<y>+ \verb+<rx>+ \verb+<ry>+ &Creates 
ellipse with radii rx and ry centered at position x,y\\ 
\verb+Square+ &\verb+<x>+ \verb+<y>+ \verb+<size>+ &Creates square with 
width size centered at position x,y\\ 
\verb+Rectangle+ &\verb+<x>+ \verb+<y>+ \verb+<dx>+ \verb+<dy>+ &Creates 
rectangle with size (dx, dy) centered at position x,y\\ 
\verb+Line+ &\verb+<x>+ \verb+<y>+ \verb+<dx>+ \verb+<dy>+ &Creates 
