...
which can be used by a script to target a specific language.  Defaults
to 'en'.\\
...
\verb+gPEBLBaseFont+& Name of the default font to use in helper
functions and most \\
&battery tasks. By default, set to``DejaVuSans.ttf''. Change this
to\\
& a new name to override.\\
\verb+gPEBLBaseFontMono+&Name of the default mono-spaced font to use in helper
functions \\
& and most battery tasks. By default, set to
``DejaVuSansMono.ttf''.  \\& Change  to a new name to override.\\
\verb+gPEBLBaseFontSerif+&Name of the default font to use in helper
functions \\
&and most battery tasks. By default, set to
``DejaVuSerif.ttf''.\\& Change to a new name to override.\\
