...
primary sources (Bitstream and SIL, a number of free fonts created
by George Williams with fontforge, and our own custom font), have a
number of font series (see below for details).
...
Made by George Williams (distributed at fontforge.sf.net):
  ...
  Humanistic.ttf		Attractive sharp-featured font
  Monospace.ttf         Monospace typewriter-esque vector font
  MonospaceBold.ttf     Monospace  (bold)
  MonospaceOblique.ttf  Monospace  font (italic)
